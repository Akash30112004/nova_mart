  ...
  return (
    <div className="min-h-screen bg-gray-100 py-10 px-4 sm:px-6 lg:px-20">
      <div className="max-w-5xl mx-auto bg-white rounded-2xl shadow-lg p-8 space-y-8">
        <h1 className="text-4xl font-bold  text-center">About NovaMart</h1>

        <p className="text-gray-700 text-lg">
          Welcome to <span className="font-semibold text-blue-600">NovaMart</span>, your one-stop destination for the latest and greatest in electronics. From cutting-edge gadgets to must-have accessories, we’re here to power up your tech life with premium products and unbeatable service.
        </p>
        ...
        <div className="space-y-6">
          <h2 className="text-2xl font-semibold text-blue-600">Why Choose NovaMart?</h2>
        ...
        <div className="text-center mt-10">
          <h3 className="text-xl font-semibold text-blue-600 mb-2">Join the NovaMart Family</h3>
